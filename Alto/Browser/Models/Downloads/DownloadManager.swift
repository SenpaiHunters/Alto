...
public class DownloadManager: NSObject, ObservableObject {
    ...
    private enum DownloadAction {
        case cancel, pause, resume, retry, remove
    }
    ...
    @MainActor
    private func completeDownload(_ downloadItem: DownloadItem, downloadTask: URLSessionDownloadTask, success: Bool, error: Error? = nil) {
...
extension DownloadManager: URLSessionDownloadDelegate {
    ...
    public func urlSession(_ session: URLSession, downloadTask: URLSessionDownloadTask, didCompleteWithError error: Error?) {
        guard let downloadItem = activeTasks[downloadTask], let error = error else { return }
